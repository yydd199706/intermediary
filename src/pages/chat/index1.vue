...
/* 底部按钮 */
.botom-in{ width:90%; overflow: hidden; padding-left:5%; padding-right:5%; padding-top:30rpx; bottom: 0; background: #f5f4f6;
border-top: 2rpx solid #eaeaea; position: fixed; z-index: 1000; height:130rpx;}
.botom-in input{ float: left; width:60%; height: 70rpx; line-height: 70rpx;border-radius: 6rpx; padding: 0 3%; border: 2rpx solid #dddcdd;
background: #fcfcfc;}
